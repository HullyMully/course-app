...
package com.courseapp.databinding;
...
public final class ActivityOnboardingBinding implements ViewBinding {
  ...
  private ActivityOnboardingBinding(@NonNull LinearLayout rootView,
      @NonNull FrameLayout chipsContainer, @NonNull MaterialButton continueButton) {
  ...
  public static ActivityOnboardingBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.chips_container;
      FrameLayout chipsContainer = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityOnboardingBinding((LinearLayout) rootView, chipsContainer, continueButton);
    }
