...
public final class ItemCourseBinding implements ViewBinding {
  ...
  private ItemCourseBinding(@NonNull MaterialCardView rootView, @NonNull TextView date,
  ...
  public static ItemCourseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCourseBinding((MaterialCardView) rootView, date, description, favoriteButton,
